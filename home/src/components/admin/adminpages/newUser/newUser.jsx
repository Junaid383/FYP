...
//                     <input type="text" placeholder='Ali Asad' />
//                 </div>
...
//                     <input type="number" placeholder='+92 316 6201209' />
//                 </div>

//                 <div className="newUserItem">
//                     <label htmlFor="">Address</label>
//                     <input type="address" placeholder='Lahore | Pakistan' />
//                 </div>
...
//                     </select>
//                 </div>
//                 <button type='submit' name='signup'  className="newUserButton">Create</button>
//             </form>
